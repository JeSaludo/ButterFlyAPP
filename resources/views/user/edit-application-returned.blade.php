    ...
    <div class="min-h-screen">
        ...
        <div class="bg-custom-bg-light-dark w-7/12  mx-auto rounded-20 pb-4 mb-4">
            <div class="mx-auto pt-2 my-4 0 ">
                <h1 class="text-center text-custom-dark-600 text-auto md:text-3xl lg:text-xl xl:text-3xl font-lora font-bold">UPDATE <span class="text-white">RETURNED  APPLICATION</span></h1>
                <p class="text-center text-custom-dark-500 text-sm md:text-default lg:text-sm xl:text-default" >Update Returned Application Information..</p>
