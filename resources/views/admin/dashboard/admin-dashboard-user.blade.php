        ...
        <div class="px-4 pt-5">
            <div class="bg-white w-full mx-auto my-4 rounded-md shadow-md">
                <div class="flex justify-between flex-col md:flex-row">
                    <div class="px-5 py-3">
                        <form action="{{ route('admin.dashboard.show-user') }}" method="GET">
                    ...
                    <div class="flex  items-center px-4 ">
                        <form action="{{ route('admin.dashboard.show-user') }}" method="GET" class="flex items-center">
                        ...
                        <div class="px-2 ">
                            <a href="/admin/dashboard/users/create" class="inline-block px-4 py-2 font-medium bg-custom-blue hover:bg-[#390A86] text-white text-xs whitespace-nowrap md:text-sm rounded-md">Create Account</a>
                          </div>
                    </div>
                </div>
