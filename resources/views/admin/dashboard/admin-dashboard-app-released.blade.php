...
<body class="bg-custom-admin-bg min-h-screen">
    ...
    <section class="main home transition-all duration-300 ease-in">     
        ...
        @include('admin.layout.dashboard-header-v2', ["title" => "Released Applications"])    
        ...
        <div class="px-4 pt-5">
            <div class="bg-white w-full mx-auto my-4 rounded-md shadow-md">
                <div class="flex justify-between flex-col md:flex-row">
                    <div class="px-5 py-3">
                        <form action="{{ route('admin.dashboard.released') }}" method="GET">
                    ...
                    <div class="flex items-center px-4">
                        <form action="{{ route('admin.dashboard.released') }}" method="GET" class="flex items-center">
