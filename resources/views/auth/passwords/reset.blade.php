                ...
                <form action="{{ route('password.update') }}" method="POST">
                    ...
                    <div class="px-2 md:px-4 xl:pl-12 mt-4 mx-2 ">
                        ...
                        <div class="mt-4">
                            ...
                            <button type="submit" class="font-poppins text-xl text-white bg-custom-blue hover:bg-[#390A86] mt-4 w-11/12 py-2 border-none rounded-md">Reset Password</button>
